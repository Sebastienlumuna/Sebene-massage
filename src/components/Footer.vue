      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div class="col-span-1 md:col-span-1">
          ...
          <div class="flex space-x-4">
            <a href="#" class="text-white hover:text-secondary-light transition-colors duration-300">
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            <li><a href="#accueil" class="text-gray-300 hover:text-white transition-colors duration-300">Accueil</a></li>
            <li><a href="#à-propos" class="text-gray-300 hover:text-white transition-colors duration-300">À propos</a></li>
        ...
        <div class="col-span-1">
          ...
          <ul class="space-y-2">
            <li class="flex items-start">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 mr-2 mt-1 text-secondary-light" viewBox="0 0 20 20" fill="currentColor">
            ...
            <li class="flex items-start">
              ...
              <span class="text-gray-300">contact@harmoniemassage.com</span>
            </li>
          </ul>
        </div>
      </div>
